        ...
        if(m.context === 'validateJava'){
            if(m.result == null){
                ...
                setOverlayContent(
                    ...
                    'In order to join The Combo Crew, you need a 64-bit installation of Java 8. Would you like us to install a copy? By installing, you accept <a href="http://www.oracle.com/technetwork/java/javase/terms/license/index.html">Oracle\'s license agreement</a>.',
                    'Install Java',
                    'Install Manually'
                )
                setOverlayHandler(() => {
        ...
        $.ajax(
            {
                ...
                success: (data) => {
                    ...
                    for(let i=0; i<items.length; i++){
                        ...
                        const date = new Date(items[i].date*1000).toLocaleDateString('en-US', {month: 'short', day: 'numeric', year: 'numeric', hour: 'numeric', minute: 'numeric'})
                        const author = items[i].author
                        const content = items[i].content
                        const comments = items[i].comments
                        const commentsLink = items[i].commentsLink
